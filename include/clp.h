...
#define Clp_OptimizationDir_minimize 1.0
#define Clp_OptimizationDir_maximize -1.0
#define Clp_OptimizationDir_ignore 0.0
...
typedef void (*clp_callback) (Clp_Simplex*  model,
                              int           msgno,
                              int           ndouble,
                              const double* dvec,
                              int           nint,
